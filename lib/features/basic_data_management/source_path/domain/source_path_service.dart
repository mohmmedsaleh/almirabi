...
import 'source_path_repository.dart';

class SourcePathService extends SourcePathRepository {
  GeneralLocalDB<SourcePath>? _generalLocalDBInstance;
  static SourcePathService? sourcePathDataServiceInstance;

  SourcePathService._() {
    _generalLocalDBInstance =
        GeneralLocalDB.getInstance<SourcePath>(fromJsonFun: SourcePath.fromJson)
            as GeneralLocalDB<SourcePath>?;
  }

  static SourcePathService getInstance() {
    sourcePathDataServiceInstance =
        sourcePathDataServiceInstance ?? SourcePathService._();
    return sourcePathDataServiceInstance!;
  }
  ...
  Future createTable() async {
    ...
    return await _generalLocalDBInstance!
        .createTable(structure: LocalDatabaseStructure.sourcePathStructure);
  }
  ...
  Future search(String query) async {
    try {
      _generalLocalDBInstance = GeneralLocalDB.getInstance<SourcePath>(
          fromJsonFun: SourcePath.fromJson) as GeneralLocalDB<SourcePath>?;
  ...
  Future createSourcePathRemotely({required obj}) async {
    // try {
  ...
  Future updateSourcePathRemotely({required int id, required obj}) async {
    // try {
    //   // print("id : $id");
